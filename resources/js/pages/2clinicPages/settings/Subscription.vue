        ...
        <SettingsLayout>
            <div class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-semibold">Subscription Dashboard</h2>
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <h3 class="text-xl font-semibold">{{ currentPlan?.name || 'Free Plan' }}</h3>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="rounded-lg border bg-card p-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="flex-1">
                                <h3 class="font-medium">Services Registered</h3>
                        ...
                        <p v-if="!isProPlan() && stats?.services_limit !== 'unlimited'" class="text-xs text-muted-foreground mt-2">
                    ...
                    <div class="rounded-lg border bg-card p-6">
                        ...
                        <p v-if="!isProPlan() && stats?.vets_limit !== 'unlimited'" class="text-xs text-muted-foreground mt-2">
