    ...
    <AppLayout>
        <div class="flex h-full flex-1 flex-col gap-4 md:gap-6 rounded-xl p-3 md:p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                    <h1 class="text-lg md:text-2xl font-semibold">Subscription Dashboard</h1>
            ...
            <div class="rounded-lg border bg-card p-3 md:p-6">
                <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-3 mb-3 md:mb-4">
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            <h2 class="text-base md:text-xl font-semibold">{{ currentPlan?.name || 'Free Plan' }}</h2>
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div class="rounded-lg border bg-card p-3 md:p-6">
                    <div class="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-sm md:text-base font-medium">Appointments This Month</h3>
                    ...
                    <p v-if="!isProPlan() && stats.appointments_limit !== 'unlimited'" class="text-[10px] md:text-xs text-muted-foreground mt-2">
                ...
                <div class="rounded-lg border bg-card p-3 md:p-6">
                    <div class="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-sm md:text-base font-medium">Staff Accounts</h3>
                            <p class="text-xs md:text-sm text-muted-foreground">
                    ...
                    <p v-if="!isProPlan() && stats.staff_limit !== 'unlimited'" class="text-[10px] md:text-xs text-muted-foreground mt-2">
                ...
                <div class="grid md:grid-cols-2 gap-3 md:gap-4">
                    <div class="flex items-start gap-2 md:gap-3">
                        <CheckCircle2 
                            ...
                            class="h-4 w-4 md:h-5 md:w-5 mt-0.5 flex-shrink-0"
                        />
                        <div class="flex-1">
                    ...
                    <div class="flex items-start gap-2 md:gap-3">
                        <CheckCircle2 class="h-4 w-4 md:h-5 md:w-5 mt-0.5 text-green-600 flex-shrink-0" />
                        <div class="flex-1">
